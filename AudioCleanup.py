...
for i in tqdm.tqdm(range(0, 700)):
    ...
    fs, sample = wavfile.read("301-project-train-noisy/sample"+ str(i) +".wav")
...
for i in tqdm.tqdm(range(700, 1000)):
    fs, sample = wavfile.read("301-project-test-noisy/sample" + str(i) + ".wav")
    ...
    wavfile.write("301-project-test-clean/clean" + str(i) + ".wav", fs, output)
